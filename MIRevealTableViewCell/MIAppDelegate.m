...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.navigationController = [[[UINavigationController alloc] initWithRootViewController:[[[MIRevealCellDemoTableViewController alloc] initWithStyle:UITableViewStylePlain] autorelease]] autorelease];
